...
#   - Script syntax validation (deploy-arm.sh, install.sh)
#   - Documentation exists
#   - Version variables valid
#
# MANUAL TESTS (require real RPi):
#   [ ] Deploy: ./scripts/deploy-arm.sh <IP> arm64
#   [ ] Verify: ssh <USER>@<IP> 'systemctl status touch-timeout'
#
...
bash -n scripts/deploy-arm.sh && echo "  OK: deploy-arm.sh"
...
[ -f INSTALLATION.md ] && echo "  OK: INSTALLATION.md exists"
